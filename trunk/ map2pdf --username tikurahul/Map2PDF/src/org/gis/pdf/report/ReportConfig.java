...
public class ReportConfig {
  ...
  private final Map<String, Class<? extends ReportGenerator>> reports = new HashMap<String, Class<? extends ReportGenerator>>();
      ...
      for (String name : names) {
        ...
        if (clsName != null) {
          try {
            ...
            throw new ServletException(clsName + " must implement the " + ReportGenerator.class.getName() + " interface!", e);
